...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('images/icons/icon-192x192.html') }}">
</head>
    ...
    <div id="page">
        ...
        <div class="page-content header-clear-small">
                        ...
                        <div class="splide__slide">
                            <div class="card card-style">
                                <div class="content mb-0">
                                    ...
                                    <p class="text-center color-highlight mt-n1 font-12">Sticky comes Prepared for You
                                    </p>
                                    <p class="boxed-text-xl mt-n3">
                                        Call to action are highly important, but we can't choose a style for you, so we
                                        created a few!
                                    </p>
                                    <a href="#"
                                        class="btn btn-m btn-center-l bg-highlight text-uppercase font-900 text-uppercase rounded-s shadow-xl mb-4">Swipe
                                        Left to Begin</a>
                                </div>
                            </div>
                        </div>
                        <div class="splide__slide">
                            <div class="card card-style">
                                <div class="content">
                                    ...
                                    <p class="text-center color-highlight mt-n1 font-12">Follow & Get in Touch with Us
                                    </p>
                                    <p class="boxed-text-xl mt-n3">
                                        It's easy. Just add your links and you're ready to go. Social links are wildely
                                        available in Sticky
                                    </p>
                                    <p class="text-center pb-2">
                                        <a href="#"
                                            class="icon icon-s rounded-s shadow-xl color-white bg-facebook"><i
                                                class="fa fa-facebook-f"></i></a>
                                        <a href="#"
                                            class="icon icon-s rounded-s shadow-xl color-white bg-phone ms-2 me-2"><i
                                                class="fa fa-phone"></i></a>
                                        <a href="#"
                                            class="icon icon-s rounded-s shadow-xl color-white bg-twitter"><i
                        ...
                        <div class="splide__slide">
                            <div class="card card-style">
                                <div class="content mb-0">
                                    ...
                                    <p class="boxed-text-xl mt-n3">
                                        Multiple choices are awesome, highlighting them is even easier with our Call to
                                        Actions
                                    </p>
                                    <p class="text-center mt-n3 mb-0 pb-0">
                                        <a href="#"
                                            class="btn btn-m bg-green-dark text-uppercase font-900 text-uppercase rounded-s shadow-xl mb-4 mt-3">Call
                                            Now</a>
                                        <a href="#"
                                            class="icon icon-m rounded-s opacity-40 color-theme ms-3 me-3">or</a>
                                        <a href="#"
                                            class="btn btn-m bg-red-dark text-uppercase font-900 text-uppercase rounded-s shadow-xl mb-4 mt-3">GET
                                            A QUOTE</a>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="splide__slide">
                            <div class="card card-style">
                                <div class="content mb-0">
                                    ...
                                    <p class="text-center color-highlight mt-n1 mb-2 font-12">Invite Users to Tap
                                        Button</p>
                                    <p class="boxed-text-xl">
                                        Make a button stand out at the top of your page so it's easily accessible as a
                                        first option.
                                    </p>
                                    <a href="#"
                                        class="btn btn-m btn-center-l bg-highlight text-uppercase font-900 text-uppercase rounded-s shadow-xl mb-4">Purchase
                                        today for $25</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card card-style">
                ...
                <div class="row me-2 ms-2 mb-0">
                    ...
                    <div class="col-6 text-center">
                        <i class="fas fa-check color-green-dark fa-3x"></i>
            ...
            <div class="card card-style">
                <div class="content mb-0">
                    ...
                    <p class="text-center color-highlight font-11 mt-n1 pb-0">Tons of Awesome Features just for You.
                    </p>
                    <p class="boxed-text-xl mt-n3">
            ...
            <div class="footer card card-style">
                ...
                <p class="footer-text"><span>Made with <i class="fa fa-heart color-highlight font-16 ps-2 pe-2"></i>
                        by Enabled</span><br><br>Powered by the best Mobile Website Developer on Envato Market. Elite
                ...
                <p class="footer-copyright">Copyright &copy; Enabled <span id="copyright-year">2017</span>. All Rights
                    Reserved.</p>
                <p class="footer-links"><a href="#" class="color-highlight">Privacy Policy</a> | <a
                        href="#" class="color-highlight">Terms and Conditions</a> | <a href="#"
        ...
        <div id="menu-install-pwa-ios" class="menu menu-box-bottom menu-box-detached rounded-l">
            <div class="boxed-text-xl mt-4 pb-3">
                ...
                <a href="#" class="pwa-dismiss close-menu color-highlight text-uppercase font-700">Maybe
                    later</a>
            </div>
        </div>
    </div>
