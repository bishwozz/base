      ...
      <div class="page-content header-clear-small">
                ...
                <div class="card card-style">
                  <div class="content">
                    ...
                    <p class="text-center pb-2">
                      <a href="#" class="icon icon-s rounded-s shadow-xl color-white bg-facebook"><i
                          class="fa fa-facebook-f"></i></a>
                      <a href="#" class="icon icon-s rounded-s shadow-xl color-white bg-phone ms-2 me-2"><i
                          class="fa fa-phone"></i></a>
                      <a href="#" class="icon icon-s rounded-s shadow-xl color-white bg-twitter"><i
        ...
        <div class="card card-style">
          <div class="content mb-0">
            ...
            <p class="boxed-text-xl mt-n3">
              Fast, easy to use and filled with features. Get Sticky Today and give your site the Mobile Feeling it
              deserves.
            </p>
            <a href="#"
              class="btn btn-m btn-center-l text-uppercase font-900 bg-highlight rounded-sm shadow-xl mb-4">Purchase Now -
              $25</a>
          </div>
        </div>
        ...
        <div class="footer card card-style">
          ...
          <p class="footer-text"><span>Made with <i class="fa fa-heart color-highlight font-16 ps-2 pe-2"></i> by
              Enabled</span><br><br>Powered by the best Mobile Website Developer on Envato Market. Elite Quality. Elite
            Products.</p>
      ...
      <div id="menu-install-pwa-android" class="menu menu-box-bottom menu-box-detached rounded-l">
        <div class="boxed-text-l mt-4 pb-3">
          ...
          <a href="#" class="pwa-install btn btn-s rounded-s shadow-l text-uppercase font-900 bg-highlight mb-2">Add to
            Home Screen</a><br>
          <a href="#" class="pwa-dismiss close-menu color-gray-dark text-uppercase font-900 opacity-60 font-10 pt-2">Maybe
            later</a>
          <div class="clear"></div>
        </div>
      </div>
