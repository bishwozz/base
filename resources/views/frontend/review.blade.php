...
@section('content')
    ...
    <div class="page-content header-clear-small">
        <div class="card card-style preload-img" data-src="images/pictures/18w.jpg" data-card-height="150">
            ...
            <div class="card-center me-3">
                {{-- <a href="#"class="back-button btn btn-m float-end rounded-xl shadow-xl text-uppercase font-800 bg-highlight">Rate us</a> --}}
                <button type="button" class="back-button btn btn-m float-end rounded-xl shadow-xl text-uppercase font-800 bg-highlight" data-toggle="modal" data-target="#exampleModal">
                  Rate us
                </button>
            </div>
