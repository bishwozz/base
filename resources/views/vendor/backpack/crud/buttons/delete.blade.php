@if ($crud->hasAccess('delete'))
    @if($crud->model->getTable() == 'agendas')
        @if ($entry->is_submitted == false && $entry->created_by == backpack_user()->id)
            ...
            data-route="{{ url($crud->route . '/' . $entry->getKey()) }}" class="btn btn-sm btn-danger delete-btn"
            data-button-type="delete" tooltip><i class="la la-trash" data-toggle="tooltip" title="Delete"></i></a>
        @endif
