...
class CreateCoreMasterTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('mst_fed_local_levels', function (Blueprint $table) {
            ...
            $table->string('deputy_mayor_name')->nullable();
        ...
        Schema::create('mst_ministries', function (Blueprint $table) {
            $table->smallIncrements('id');
            $table->string('code',20);
            ...
            $table->unique(['code','deleted_uq_code'],'uq_mst_ministries_code');
            $table->unique(['name_lc','deleted_uq_code'],'uq_mst_ministries_name_lc');
            $table->unique(['name_en','deleted_uq_code'],'uq_mst_ministries_name_en');
