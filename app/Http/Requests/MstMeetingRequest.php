...
class MstMeetingRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            'name_lc'=>'required|max:200|unique:mst_meetings,name_lc'.$name_lc_check,
            'name_en'=>'max:200|unique:mst_meetings,name_en'.$name_en_check,
            'date_ad' => 'max:10',
            'date_bs' => 'max:10',
            'remarks' => 'max:500',
