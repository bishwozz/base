...
class MstStepRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            'name_lc'=>'required|max:200|unique:mst_steps,name_lc'.$name_lc_check,
            'name_en'=>'max:200|unique:mst_steps,name_en'.$name_en_check,
            'remarks' => 'max:500',
