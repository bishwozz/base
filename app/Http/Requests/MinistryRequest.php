...
class MinistryRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $id_check = isset($request_id) ? ",".$request_id : ",NULL";
        ...
        return [
            'code'=>'required|max:200|numeric|unique:ec_ministry,code'.$name_lc_check,
            'name_lc'=>'required|max:200|unique:ec_ministry,name_lc'.$name_lc_check,
            'name_en'=>'max:200|unique:ec_ministry,name_en'.$name_en_check,
            'remarks' => 'max:500',
